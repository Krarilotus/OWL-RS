...
- externally visible `rules-mvp` preset/tier metadata so the active bounded RDFS/OWL slice is inspectable through runtime diagnostics instead of being inferred from feature flags alone
