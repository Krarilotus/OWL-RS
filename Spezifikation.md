...
- Protokoll- und Fuseki-Paritaet: `partial`
  ...
  - lokale Side-by-Side-Evidenz gegen Apache Jena Fuseki 6.0.0 liegt jetzt fuer FOAF sowie fuer Medium-/Broad-Kataloglaeufe offizieller Ontologien auf dem normalen `pack-report.json`-/`pack-matrix-report.json`-Pfad vor
