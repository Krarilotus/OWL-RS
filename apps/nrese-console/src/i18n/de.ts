...
export const de: AppStrings = {
  ...
  runtimeReadModelLabel: "Read-Modell",
  runtimeTierLabel: "Reasoning-Tier",
  runtimeStoreLabel: "Store",
  runtimeDurabilityLabel: "Dauerhaftigkeit",
  runtimeAiLabel: "KI",
  runtimeNoOntologyPath: "Kein expliziter Ontologie-Pfad vorkonfiguriert.",
  ...
  reasoningUnsupportedLabel: "Unsupported-Konstrukte",
  reasoningLastRunLabel: "Letzter Lauf",
  reasoningFeatureModesLabel: "Feature-Modi",
  reasoningCapabilitiesLabel: "Reasoning-Capabilities",
  reasoningCapabilityDefaultLabel: "Standardmaessig aktiv",
  reasoningCapabilityMaturityLabel: "Reifegrad",
  reasoningConfigSnippetLabel: "Laufzeit-Config-Snippet",
  reasoningCacheExecutionLabel: "Execution-Cache",
  reasoningCacheSchemaLabel: "Schema-Cache",
  reasoningCacheExecutionTotalsLabel: "Execution-Cache gesamt (Hits / Misses)",
  reasoningCacheSchemaTotalsLabel: "Schema-Cache gesamt (Hits / Misses)",
  reasoningCoverageTitle: "Snapshot-Abdeckung",
  reasoningCoverageSupportedLabel: "Unterstuetzte assertierte Tripel",
  reasoningCoverageUnsupportedLabel: "Nicht unterstuetzte assertierte Tripel",
  reasoningCoverageBlankSubjectLabel: "Uebersprungene Blank-Node-Subjekte",
  reasoningCoverageBlankObjectLabel: "Uebersprungene Blank-Node-Objekte",
  reasoningCoverageLiteralObjectLabel: "Uebersprungene Literal-Objekte",
  reasoningCoverageFlattenedQuadsLabel: "Abgeflachte Named-Graph-Quads",
